...
$devtools = [ 'aptitude', 'cfengine3', 'devscripts', 'dnsutils', 'git', 'gparted', 'inotify-tools', 'macchanger', 'numlockx', 'p7zip', 'qemu', 'rdesktop', 'remmina', 'synaptic', 'terminator', 'terminology', 'tmux', 'x11-utils', 'xarchiver', 'xkbset' ]
...
$Internet = [ 'aria2', 'curl', 'firefox', 'links2', 'midori', 'network-manager', 'nmap', 'thunderbird', 'w3m' ]
